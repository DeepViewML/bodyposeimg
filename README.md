...
The provided model follows this labeling for keypoints
Id 	Part
0 	nose
1 	leftEye
2 	rightEye
...
At this point the bodyposeimg application will be built and can be run using the provided samples or using your own model and image.
```
./bodyposeimg -e cpu -n signed skeleton_pose_lightning.rtm 000000065736.jpg
VisionPack 1.4.3 EVALUATION - Copyright 2022 Au-Zone Technologies
Load: 51.5335 Infer: 139.6074 Decode: 0.4916
  [  0] - ( 69%): 0.34 0.11
  [  1] - ( 50%): 0.36 0.09
  [  2] - ( 24%): 0.33 0.09
  [  3] - ( 75%): 0.38 0.09
